    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
              ...
              {!logoError ? (
                <img
                  ...
                  className={`w-auto logo-clickable logo-fade transition-all duration-300 ${
                    isScrolled ? 'h-10 sm:h-11' : 'h-12 sm:h-16'
                  }`}
                  onClick={scrollToTop}
      ...
      <main>
        ...
        <div className="relative bg-white pb-20">
          {/* Credit Cards Section */}
          <section id="credit-cards-section" className="pb-20 pt-0 sm:pt-12">
            ...
            <div className="w-full">
              ...
              {alternatingFeatures.map((feature, index) => (
                <div key={index} className="py-10" style={{backgroundColor: '#FFFFFF'}}>
                  <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-2 gap-7 lg:gap-12 items-center">
