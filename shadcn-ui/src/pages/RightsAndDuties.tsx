        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-8">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-semibold mb-4" style={{color: '#182C64'}}>
              1. Your Rights as a NXT User
            </h2>
            <p className="text-gray-700 mb-6">
              As a valued NXT customer, you have fundamental rights that we are committed to protecting and upholding. These rights ensure that you have control over your financial services experience and that we maintain the highest standards of service delivery.
            </p>
            ...
            <div className="mb-6">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                ...
                <li>Right to update your personal information and preferences</li>
                <li>Right to download and export your financial data</li>
              </ul>
            </div>
            ...
            <div className="mb-8">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                ...
                <li>Right to account portability and service termination</li>
            ...
            <p className="text-gray-700 mb-6">
              Along with your rights, you have certain duties and responsibilities when using NXT services. These ensure the security, integrity, and proper functioning of our platform for all users.
            </p>
            ...
            <div className="mb-8">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                ...
                <li>Report changes in your financial status when required</li>
                <li>Cooperate with regulatory and compliance requests</li>
              </ul>
            </div>
          </div>
        </div>
