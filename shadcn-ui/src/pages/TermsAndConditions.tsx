        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-8">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-gray-700 mb-6">
              By accessing and using NXT's digital wallet services, you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions. These terms constitute a legally binding agreement between you and NXT. If you do not agree to these terms, please do not use our services.
            </p>
            <p className="text-gray-700 mb-6">
              We may update these terms from time to time to reflect changes in our services, legal requirements, or business practices. We will notify you of any material changes through our platform or via email. Your continued use of our services after such changes constitutes acceptance of the updated terms.
            </p>
            ...
            <p className="text-gray-700 mb-4">
              NXT provides comprehensive digital wallet services designed to simplify your financial life. Our services include but are not limited to:
            </p>
            <div className="mb-6">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                ...
                <li>Financial analytics and budgeting tools</li>
            ...
            <div className="mb-8">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                ...
                <li>Secure API access for third-party integrations</li>
